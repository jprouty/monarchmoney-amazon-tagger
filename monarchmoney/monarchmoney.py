...
class MonarchMoney(object):
    ...
    async def get_transaction_details(self, transaction_id: str, redirect_posted: bool = True) -> Dict[str, Any]:
        ...
        query = gql(
            """
          query GetTransactionDrawer(: UUID: Boolean) {
            getTransaction(id: , redirectPosted: ) {
              id
              amount
              pending
              isRecurring
    ...
    async def get_transaction_splits(self, transaction_id: str) -> Dict[str, Any]:
        ...
        query = gql(
            """
          query TransactionSplitQuery(: UUID{
            getTransaction(id: ) {
              id
              amount
              category {
    ...
    async def update_transaction_splits(self, transaction_id: str, split_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        query = gql(
            """
          mutation Common_SplitTransactionMutation(: UpdateTransactionSplitMutationInput{
            updateTransactionSplit(input: ) {
              errors {
                ...PayloadErrorFields
                __typename
              }
