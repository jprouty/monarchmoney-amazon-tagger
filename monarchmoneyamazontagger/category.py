                ...
                (11, 12): RangeKeyDict(
                    {
                        ...
                        (
                            17,
                            18,
                        ): "Home Supplies",  # Paper products like TP, paper towels
                    }
                ),
            }
        ),
...
def get_mint_category_from_unspsc(unspsc_code):
    ...
    segment_node = UNSPSC_TO_MINT_CATEGORY.get(segment_code, DEFAULT_MINT_CATEGORY)
    ...
    family_node = segment_node.get(family_code, segment_default)
    ...
    class_node = family_node.get(class_code, family_node.get(0, family_default))
    ...
    commodity_node = class_node.get(commodity_code, class_node.get(0, class_default))
