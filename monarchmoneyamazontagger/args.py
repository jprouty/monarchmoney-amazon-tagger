...
def define_common_args(parser):
    ...
    parser.add_argument(
        ...
        help=(
            'One or more Amazon Data Exports zip file (type either "Orders" or "All Data").'
        ),
    )

    # Monarch Money creds:
    parser.add_argument(
        "--mm_email", default=None, help=("Monarch Money e-mail address for login.")
    )
    parser.add_argument(
        "--mm_password", default=None, help=("Monarch Money password for login.")
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "The prefix to use when updating the description for each Mint "
    ...
    parser.add_argument(
        ...
        default=(
            "amazon.com,amazon.cn,amazon.in,amazon.co.jp,amazon.com.sg,"
        ...
        help=(
            "A list of all valid Amazon domains/websites. These should "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Itemize everything, instead of the default behavior, which is "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Do not split Monarch Money transactions into individual items with "
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Only send the first N updates to Monarch Money (or print N updates at "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "For transactions that have been previously tagged by this "
    ...
    parser.add_argument(
        "--max_unmatched_charges_combinations",
        type=int,
        default=20,
        help=(
            "Maximum number of charges to attempt to combinatorically match with "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Do not update Monarch Money categories. This is useful as "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Do not attempt to predict custom category tagging based on any "
    ...
    parser.add_argument(
        ...
        default=5,
        help=(
            "How many days are allowed to pass between when Amazon has "
    ...
    parser.add_argument(
        ...
        default="amazon,amzn",
        help=(
            "Only consider Monarch Money transactions that have one of these strings "
            "in the description field. Case-insensitive comma-separated."
        ),
    )
    parser.add_argument(
        "--mm_input_include_user_description",
        action="store_true",
        help=(
            "Consider using the current description from Monarch Money when "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Consider using the inferred description from Monarch Money's "
    ...
    parser.add_argument(
        "--mm_input_categories_filter",
        type=str,
        help=(
            "Only consider Monarch Money transactions that match one of "
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "Saves a backup of your Monarch Money transactions to a json file, "
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Do not fetch categories or transactions from Monarch Money. Use json "
...
def define_cli_args(parser):
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Do not modify Mint transaction; instead print the proposed "
            "changes to console."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-V", "--version", action="store_true", help="Shows the app version and quits."
    )
